      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
          <table class="cart-table">
            ...
            @foreach ($items as $item)
              <tr>
                ...
                <td>
                  <span class="shopping-cart__subtotal">Rp {{$item->subTotal()}}.000</span>
                </td>
                <td>
          ...
          <div class="cart-table-footer">
            ...
            <form action="{{route('cart.empty')}}" method="POST">
              @csrf
              @method('DELETE')
              <button class="btn btn-light" type="submit" style="border-radius:10px; background-color:brown; color:white">CLEAR CART</button>
            </form>
          </div>
          <div>
          ...
          <div class="sticky-content">
            <div class="shopping-cart__totals">
              ...
              <table class="cart-totals">
                <tbody>
                  <tr>
                    <th>Subtotal</th>
                    <td>Rp {{Cart::instance('cart')->subtotal()}}0</td>
                  </tr>
                  <tr>
                    <th>Discount {{Session::get('coupon')['code']}} </th>
                    <td>Rp {{Session::get('discounts')['discount']}}.000</td>
                  </tr>
                  <tr>
                    <th>Subtotal After Discount</th>
                    <td>Rp {{Session::get('discounts')['subtotal']}}.000</td>
                  </tr>
                  <tr>
                    <th>Shipping</th>
                    <td>Free</td>
                  ...
                  <tr>
                    <th>VAT</th>
                    <td>Rp {{Session::get('discounts')['tax']}}.000</td>
                  </tr>
                  <tr>
                    <th>Total</th>
                    <td>Rp {{Session::get('discounts')['total']}}.000</td>
                  </tr>
                </tbody>
              </table>
              ...
              <table class="cart-totals">
                <tbody>
                  ...
                  <tr>
                    <th>VAT</th>
                    <td>Rp {{Cart::instance('cart')->tax()}}0</td>
                  </tr>
                  <tr>
                    <th>Total</th>
                    <td>Rp {{Cart::instance('cart')->total()}}0</td>
                  </tr>
                </tbody>
              </table>
              @endif
            ...
            <div class="mobile_fixed-btn_wrapper">
              <div class="button-wrapper container">
                <a href="{{route('cart.checkout')}}" class="btn btn-primary btn-checkout" style="border-radius: 10px">PROCEED TO CHECKOUT</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center pt-5 bp-5">
                <p style="font-size: 20px; color: red">No item found in your cart</p>
                <a href="{{route('shop.index')}}" class="btn btn-info" style="border-radius: 10px;">Shop Now</a>
            </div>
        </div>
        @endif
      </div>
