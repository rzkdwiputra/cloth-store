              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-totals">
                    <tbody>
                        <tr>
                          <th>Subtotal</th>
                          <td class="text-right">Rp {{Cart::instance('cart')->subtotal()}}0</td>
                        </tr>
                        <tr>
                          <th>Discount {{Session::get('coupon')['code']}} </th>
                          <td class="text-right">Rp {{Session::get('discounts')['discount']}}.000</td>
                        </tr>
                        <tr>
                          <th>Subtotal After Discount</th>
                          <td class="text-right">Rp {{Session::get('discounts')['subtotal']}}.000</td>
                        </tr>
                        <tr>
                          <th>Shipping</th>
                        ...
                        <tr>
                          <th>VAT</th>
                          <td class="text-right">Rp {{Session::get('discounts')['tax']}}.000</td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td class="text-right">Rp {{Session::get('discounts')['total']}}.000</td>
                        </tr>
                      </tbody>
                  </table>
                </div>
                ...
                <table class="checkout-totals">
                  <tbody>
                    ...
                    <tr>
                      <th>VAT</th>
                      <td class="text-right">Rp {{Cart::instance('cart')->tax()}}0</td>
                    </tr>
                    <tr>
                      <th>TOTAL</th>
                      <td class="text-right">Rp {{Cart::instance('cart')->total()}}0</td>
                    </tr>
                  </tbody>
                </table>
                @endif
