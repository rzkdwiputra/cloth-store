                    ...
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            {{-- <img class="" id="logo_header_1" alt="" src="{{ asset('images/logo/logo.png') }}"
                                ...
                                <h3 class="teks-retail">Cloth Retail</h3>
                        </a>
                ...
                <div class="section-content-right">
                                        ...
                                        {{-- <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <h3 class="body-title mb-2" style="font-size: 20px;">{{ auth()->user()->name }}</h3>
                                                    <span class="text-tiny" style="font-size: 15px;">Admin</span>
                                                </span>
                                            </span>
                                        {{-- </button> --}}
                                        {{-- <ul class="dropdown-menu dropdown-menu-end has-content"
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Cloth Retail</div>
                        </div>
                    </div>
