...
<style>
  ...
  .brand-list li .chk-brand, .category-list li .chk-category{
    ...
    height: 1rem;
    color: #e4e4e4;
    border: 0.123rem solid currentColor;
    border-radius: 0;
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1000"
                data-slider-max="5000000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="Rp" />
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby">
              ...
              <option value="4" {{$order == 4 ? 'selected':''}}>Prize, Hight To Low</option>
            </select>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                  ...
                  <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="Add To Cart" style="border-radius: 10px;">Add To Cart</button>
                </form>
                @endif
              </div>
